...
public static class TranslationHelper
{
        ...
        string domain = "QuickLookNext")
    {
        if (file == null)
        {
            var subDir = domain == "QuickLookNext" ? string.Empty : $"QuickLookNext.Plugin\\{domain}";
            file = Path.Combine(
                Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), // path of QuickLookNext.Common.dll
