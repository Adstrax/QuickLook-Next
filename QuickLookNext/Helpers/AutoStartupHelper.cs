...
internal static class AutoStartupHelper
{
    ...
    internal static void CreateAutorunShortcut()
    {
        ...
        catch (Exception e)
        {
            ...
            TrayIconManager.ShowNotification(string.Empty, "Failed to add QuickLookNext to Startup folder.");
        }
    }
    ...
    internal static void RemoveAutorunShortcut()
    {
        ...
        {
            ProcessHelper.WriteLog(e.ToString());
            TrayIconManager.ShowNotification(string.Empty, "Failed to delete QuickLookNext startup shortcut.");
        }
    }
