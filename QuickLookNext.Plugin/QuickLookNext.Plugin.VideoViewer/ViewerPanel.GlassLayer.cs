...
public partial class ViewerPanel : UserControl, IDisposable, INotifyPropertyChanged
{
    ...
    private partial void LoadAndInsertGlassLayer()
    {
        ...
        // Implementation without dependencies of QuickLook-Next.exe assembly

            //<glassLayer:GlassLayer xmlns:glassLayer='clr-namespace:QuickLookNext.Controls.GlassLayer;assembly=QuickLook-Next'
        ...
        try
        {
            var loadedAssemblies = AppDomain.CurrentDomain.GetAssemblies()
                .First(a => a.GetName(false).Name == "QuickLook-Next");

            var glassLayerType = loadedAssemblies?.GetType("QuickLookNext.Controls.GlassLayer.GlassLayer")
                ?? throw new TypeLoadException
                (
                    """
                    The type 'QuickLookNext.Controls.GlassLayer.GlassLayer' could not be found in the loaded assembly 'QuickLook-Next.exe'.
