...
namespace QuickLookNext.Plugin.OfficeViewer;
...
public sealed class Plugin : IViewer
{
    ...
    public bool CanHandle(string path)
    {
        ...
        var checkPreviewHandler = SettingHelper.Get("CheckPreviewHandler", true, "QuickLookNext.Plugin.OfficeViewer");
    ...
    public void View(string path, ContextObject context)
    {
        ...
        if (ZoneIdentifierManager.IsZoneBlocked(path))
        {
            ...
            var alwaysUnblockProtectedView = SettingHelper.Get("AlwaysUnblockProtectedView", false, "QuickLookNext.Plugin.OfficeViewer");
