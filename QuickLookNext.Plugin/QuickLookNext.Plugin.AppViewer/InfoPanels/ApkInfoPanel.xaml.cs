...
using QuickLookNext.Plugin.AppViewer.PackageParsers.Apk;
using System;
            ...
            if (File.Exists(path))
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    if (info.HasIcon)
                    {
                        ...
                        {
                            Debug.WriteLine(e);
                            image.Source = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.AppViewer;component/Resources/android.png"));
                        }
                    }
                    else
                    {
