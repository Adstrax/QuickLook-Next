...
using QuickLookNext.Plugin.AppViewer.PackageParsers.Hap;
using System;
...
namespace QuickLookNext.Plugin.AppViewer.InfoPanels;
        ...
        _ = Task.Run(() =>
        {
            if (File.Exists(path))
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    {
                        background.Source = null;
                        foreground.Source = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.AppViewer;component/Resources/harmonyos.png"));
                    }
