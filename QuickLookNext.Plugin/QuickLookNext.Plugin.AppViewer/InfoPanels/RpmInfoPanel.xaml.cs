...
using QuickLookNext.Plugin.AppViewer.PackageParsers.Rpm;
using System;
            ...
            if (File.Exists(path))
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    else
                    {
                        ...
                        image.Source = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.AppViewer;component/Resources/rpm.png"));
                    }
