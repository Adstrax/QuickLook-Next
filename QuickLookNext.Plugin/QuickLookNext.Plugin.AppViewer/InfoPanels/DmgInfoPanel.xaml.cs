...
using QuickLookNext.Plugin.AppViewer.PackageParsers.Dmg;
using System;
        ...
        _ = Task.Run(() =>
        {
            if (File.Exists(path))
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    ...
                    {
                        image.Source = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.AppViewer;component/Resources/ios.png"));
                    }
