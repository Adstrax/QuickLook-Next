...
namespace QuickLookNext.Plugin.CLSIDViewer;
...
internal static class RecycleBinHelper
{
    ...
    public static RecycleBinInfo GetRecycleBinInfo()
    {
        ...
        if (Environment.OSVersion.Version.Major >= 10)
        {
            ...
            {
                bitmapSources[0] = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.CLSIDViewer;component/Resources/recyclebinempty.png"));
                bitmapSources[1] = new BitmapImage(new Uri("pack://application:,,,/QuickLookNext.Plugin.CLSIDViewer;component/Resources/recyclebinfull.png"));
