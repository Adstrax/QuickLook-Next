...
using QuickLookNext.Plugin.ImageViewer.Webview.Drawio;
using QuickLookNext.Plugin.ImageViewer.Webview.Excalidraw;
using QuickLookNext.Plugin.ImageViewer.Webview.Graphviz;
using QuickLookNext.Plugin.ImageViewer.Webview.Lottie;
using QuickLookNext.Plugin.ImageViewer.Webview.PlantUml;
using QuickLookNext.Plugin.ImageViewer.Webview.Svg;
using QuickLookNext.Plugin.ImageViewer.Webview.Svga;
using QuickLookNext.Plugin.ImageViewer.Webview.Tgs;
using System;
using System.IO;
using System.Windows;

namespace QuickLookNext.Plugin.ImageViewer.Webview;
...
internal static class WebHandler
{
    public static bool TryCanHandle(string path)
    {
        ...
        {
            ".svg" => SettingHelper.Get("RenderSvgWeb", true, "QuickLookNext.Plugin.ImageViewer"),
            ".svga" or ".lottie" => true,
    ...
    public static bool TryPrepare(string path, ContextObject context, out IWebMetaProvider metaWeb)
    {
         ...
         || ext == ".excalidraw")
        {
            if (ext == ".svg")
            {
                if (!SettingHelper.Get("RenderSvgWeb", true, "QuickLookNext.Plugin.ImageViewer"))
                {
                    metaWeb = null;
                    return false;
                }
