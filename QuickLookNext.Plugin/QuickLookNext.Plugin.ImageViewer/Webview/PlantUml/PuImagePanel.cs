...
using QuickLookNext.Plugin.HtmlViewer;
...
namespace QuickLookNext.Plugin.ImageViewer.Webview.PlantUml;
...
public class PuImagePanel : SvgImagePanel
{
    ...
    {
        bool consented = SettingHelper.Get("PlantUMLOnlineConsented", false, "QuickLookNext.Plugin.ImageViewer");
        ...
        if (!consented)
        {
            ...
            SettingHelper.Set("PlantUMLOnlineConsented", true, "QuickLookNext.Plugin.ImageViewer");
        }
