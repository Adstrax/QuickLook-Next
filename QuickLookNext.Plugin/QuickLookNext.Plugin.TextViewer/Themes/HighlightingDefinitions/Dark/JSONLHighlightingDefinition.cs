...
using QuickLookNext.Plugin.TextViewer.Themes.HighlightingDefinitions.Light;
using System.Collections.Generic;

namespace QuickLookNext.Plugin.TextViewer.Themes.HighlightingDefinitions.Dark;
