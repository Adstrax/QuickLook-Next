...
namespace QuickLookNext.Plugin.TextViewer.Themes;
...
public class HighlightingThemeManager
{
    ...
    public static HighlightingTheme GetHighlightingByExtensionOrDetector(string path, string extension, string text = null)
    {
        ...
        var useFormatDetector = SettingHelper.Get("UseFormatDetector", true, "QuickLookNext.Plugin.TextViewer");
        ...
        var darkThemeAllowed = SettingHelper.Get("AllowDarkTheme", highlightingTheme.IsDark, "QuickLookNext.Plugin.TextViewer");
