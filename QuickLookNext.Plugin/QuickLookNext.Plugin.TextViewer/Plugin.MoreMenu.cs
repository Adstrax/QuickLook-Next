...
public sealed partial class Plugin
{
    public IEnumerable<IMenuItem> GetMenuItems()
    {
        ...
        {
            // HTML <=> HTML TEXT
            // \QuickLookNext\QuickLookNext.Plugin\QuickLookNext.Plugin.TextViewer\Syntax\Light\zzz-After-JavaScript-HTML.xshd
            ...
            ".html" or ".htm" or ".xhtml" or ".shtml" or ".shtm" or ".xht" or ".hta" => new MoreMenuItem()
            {
                ...
                Command = new RelayCommand(() => PluginHelper.InvokePluginPreview("QuickLookNext.Plugin.HtmlViewer", _currentPath)),
            },
            ...
            ".svg" => new MoreMenuItem()
            {
                ...
                Command = new RelayCommand(() => PluginHelper.InvokePluginPreview("QuickLookNext.Plugin.ImageViewer", _currentPath)),
            },
            ...
            ".csv" or ".tsv" or ".psv" => new MoreMenuItem()
            {
                ...
                Command = new RelayCommand(() => PluginHelper.InvokePluginPreview("QuickLookNext.Plugin.CsvViewer", _currentPath)),
            },
            _ => null,
        };
