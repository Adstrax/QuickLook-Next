...
public partial class PluginInfoPanel : UserControl
{
    ...
    private void BtnInstall_Click(object sender, RoutedEventArgs e)
    {
        ...
        t.ContinueWith(_ =>
            ...
            {
                btnInstall.Content = "Done! Please restart QuickLookNext.";
    ...
    private void ReadInfo()
    {
        ...
        var xml = LoadXml(GetFileFromZip(_path, "QuickLookNext.Plugin.Metadata.config"));

        _namespace = GetString(xml, @"/Metadata/Namespace");

        var okay = _namespace != null && _namespace.StartsWith("QuickLookNext.Plugin.");
