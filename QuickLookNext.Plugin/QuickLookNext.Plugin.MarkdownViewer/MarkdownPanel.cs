...
namespace QuickLookNext.Plugin.MarkdownViewer;

public class MarkdownPanel : WebpagePanel
{
    protected const string _resourcePrefix = "QuickLookNext.Plugin.MarkdownViewer.Resources.";
    ...
    protected string GenerateMarkdownHtml(string path)
    {
        ...
        var tocShortcut = SettingHelper.Get("ToggleTocKey", "Ctrl+Shift+L", "QuickLookNext.Plugin.MarkdownViewer");
